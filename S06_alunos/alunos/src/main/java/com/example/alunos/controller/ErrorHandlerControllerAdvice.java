...
public class ErrorHandlerControllerAdvice {
    ...
    public ResponseEntity<?> constraintViolation(ConstraintViolationException exception) {
        ...
        String mensagem = "Ocorreu um erro em atributos que devem possuir valores únicos";

        if (exception.getConstraintName().contains("UK_NUMERO_E_DATA_MATRICULA")) {
            mensagem = "Já existe um aluno com o numero de matricula cadastrado nesta data";
        }
